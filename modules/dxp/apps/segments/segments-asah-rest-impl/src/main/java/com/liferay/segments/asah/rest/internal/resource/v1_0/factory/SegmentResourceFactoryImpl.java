 ...
 */
@Component(
	property = "resource.locator.key=/segments-asah/v1.0/Segment",
...
public class SegmentResourceFactoryImpl implements SegmentResource.Factory {
	...
	public SegmentResource.Builder create() {
		return new SegmentResource.Builder() {
			...
			public SegmentResource build() {
				...
				Function<InvocationHandler, SegmentResource>
					segmentResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_segmentResourceProxyProviderFunction;

				return segmentResourceProxyProviderFunction.apply(
			...
			@Override
			public SegmentResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
	...
	private Object _invoke(
		...
		segmentResource.setContextUriInfo(uriInfo);
		...
		segmentResource.setSortParserProvider(_sortParserProvider);

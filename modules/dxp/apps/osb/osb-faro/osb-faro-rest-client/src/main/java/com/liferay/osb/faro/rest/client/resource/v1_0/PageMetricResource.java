...
public interface PageMetricResource {
	...
	public Page<PageMetric> getSitePagesPage(
			Long siteId, String channelId, String dataSourceId, String rangeEnd,
			Integer rangeKey, String rangeStart, String search,
			Pagination pagination, String sortString)
		throws Exception;

	public HttpInvoker.HttpResponse getSitePagesPageHttpResponse(
			Long siteId, String channelId, String dataSourceId, String rangeEnd,
			Integer rangeKey, String rangeStart, String search,
			Pagination pagination, String sortString)
		throws Exception;
	...
	public static class PageMetricResourceImpl implements PageMetricResource {
		...
		public Page<PageMetric> getSitePagesPage(
				Long siteId, String channelId, String dataSourceId,
				String rangeEnd, Integer rangeKey, String rangeStart,
				String search, Pagination pagination, String sortString)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getSitePagesPageHttpResponse(
					siteId, channelId, dataSourceId, rangeEnd, rangeKey,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/faro-rest/v1.0/sites/{siteId}/pages");
...
// LIFERAY-REST-BUILDER-HASH:647973344
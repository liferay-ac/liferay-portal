...
public class EventSerDes {
	...
	public static String toJSON(Event event) {
		...
		if (event.getEmailAddressHashed() != null) {
			...
			sb.append(_escape(event.getEmailAddressHashed()));
	...
	public static Map<String, String> toMap(Event event) {
		...
		if (event.getEmailAddressHashed() == null) {
			...
			map.put(
				"emailAddressHashed",
				String.valueOf(event.getEmailAddressHashed()));
		}
	...
	public static class EventJSONParser extends BaseJSONParser<Event> {
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "applicationId")) {
				...
				if (jsonParserFieldValue != null) {
					event.setEmailAddressHashed((String)jsonParserFieldValue);
				}
			}
			else if (Objects.equals(jsonParserFieldName, "name")) {
				if (jsonParserFieldValue != null) {
...
// LIFERAY-REST-BUILDER-HASH:337684783
...
public interface AssetSummaryMetricResource {
	...
	public Page<AssetSummaryMetric> getSiteAssetSummariesPage(
			Long siteId, String channelId, String rangeEnd, Integer rangeKey,
			String rangeStart, String search, Pagination pagination,
			String sortString)
		throws Exception;

	public HttpInvoker.HttpResponse getSiteAssetSummariesPageHttpResponse(
			Long siteId, String channelId, String rangeEnd, Integer rangeKey,
			String rangeStart, String search, Pagination pagination,
			String sortString)
		throws Exception;
	...
	public static class AssetSummaryMetricResourceImpl
		...
		public Page<AssetSummaryMetric> getSiteAssetSummariesPage(
				Long siteId, String channelId, String rangeEnd,
				Integer rangeKey, String rangeStart, String search,
				Pagination pagination, String sortString)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getSiteAssetSummariesPageHttpResponse(
					siteId, channelId, rangeEnd, rangeKey, rangeStart, search,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/faro-rest/v1.0/sites/{siteId}/asset-summaries");
...
// LIFERAY-REST-BUILDER-HASH:1288666365
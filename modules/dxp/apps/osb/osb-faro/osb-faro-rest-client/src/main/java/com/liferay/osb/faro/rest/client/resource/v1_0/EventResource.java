...
public interface EventResource {
	...
	public HttpInvoker.HttpResponse getSiteChannelEventsPageHttpResponse(
			Long siteId, String channelId, Boolean includeAnonymousUsers,
			String rangeEnd, Integer rangeKey, String rangeStart, String search,
			Pagination pagination)
		throws Exception;
	...
	public static class EventResourceImpl implements EventResource {
		...
		public Page<Event> getSiteChannelEventsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getSiteChannelEventsPageHttpResponse(
					siteId, channelId, includeAnonymousUsers, rangeEnd,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/faro-rest/v1.0/sites/{siteId}/channels/{channelId}/events");
...
// LIFERAY-REST-BUILDER-HASH:112734261
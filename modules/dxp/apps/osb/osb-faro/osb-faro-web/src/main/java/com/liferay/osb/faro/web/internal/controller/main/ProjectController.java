...
public class ProjectController extends BaseFaroController {
			...
			new CompanyInheritableThreadLocalCallable<>(
				() -> {
					...
					for (FaroProject faroProject :
						...
						List<ProjectUsageMetric> faroProjectUsages =
							_getFaroProjectUsage(
	...
	private List<ProjectUsageMetric> _getFaroProjectUsage(
		FaroProject faroProject,
		Map<String, Map<String, List<ProjectUsageMetric>>>
	...
	private ProjectUsageMetricDisplay _getProjectUsageMetricDisplay(
		...
		if (endDate != null) {
			predicate = predicate.and(
				faroProjectUsageTable.createTime.lt(endDate.getTime()));
		}
		...
		List<Object[]> results = _faroProjectUsageLocalService.dslQuery(
			DSLQueryFactoryUtil.select(
				...
				predicate.and(
					faroProjectUsageTable.createTime.gte(
		...
		if (startDate != null) {
			predicate = predicate.and(
				faroProjectUsageTable.createTime.gte(startDate.getTime()));
		}

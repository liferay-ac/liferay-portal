...
public class ProjectUsageDisplay {
	...
	public ProjectUsageDisplay(
		...
		if (includeIndividualsCounts) {
			_individualsCounts = new CountsDisplay(
		...
		if (includePageViewsCounts) {
			_pageViewsCounts = new CountsDisplay(
				includePageViewsCounts,
				JSONFactoryUtil.createJSONObject(
	...
	public CountsDisplay getIndividualsCounts() {
	...
	public CountsDisplay getPageViewsCounts() {
	...
	private CountsDisplay _individualsCounts;
	...
	private CountsDisplay _pageViewsCounts;

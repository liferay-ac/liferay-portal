...
/**
 * Per-month usage metric returned by the project display endpoint (Option A,
 * monthly view).
 *
 * <p>
 * The values are currently placeholders. See the design at
 * docs/superpowers/specs/2026-06-16-faro-project-display-usage-metrics-option-a-monthly-design.md
 * for the real data sources to wire in later.
 * </p>
 *
...
public class UsageMetricSummary {
	...
	public UsageMetricSummary(
		long apiRequestsCount, long batchSegmentsCount,

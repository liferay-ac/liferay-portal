...
import com.liferay.osb.faro.web.internal.model.display.contacts.card.template.LifetimeValueContactsCardTemplateDisplay;
...
public class LifetimeValueContactsCardTemplateType
	...
	public Class<? extends ContactsCardTemplateDisplay> getDisplayClass() {
		return LifetimeValueContactsCardTemplateDisplay.class;
	}

	@Override
	public int getType() {
		return ContactsCardTemplateConstants.TYPE_LIFETIME_VALUE;
	}

	private static final String _DEFAULT_NAME = "Average Lifetime Value";

...
@Generated("")
@GraphQLName(
	description = "A single tracked analytics event captured — page views, custom events, form submissions, etc. Each event carries free-form `attributes` (a name-value map of contextual properties) plus any matching page metadata.",
	value = "Event"
)
...
public class Event implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Event name as defined in EventDefinition (e.g. 'pageViewed', 'formSubmitted', etc.)."
	)
...
// LIFERAY-REST-BUILDER-HASH:-976946511
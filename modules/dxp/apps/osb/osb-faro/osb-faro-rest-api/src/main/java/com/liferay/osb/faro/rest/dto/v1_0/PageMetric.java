...
@Generated("")
@GraphQLName(
	description = "Analytics metrics for a single tracked page over the selected date range. Aggregates view, visitor, bounce, and access-path metrics flattened from the metric tree. Use `getSitePagesPage` to list these for a site.",
	value = "PageMetric"
)
...
public class PageMetric implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Identifier of the page. The canonical URL of the page."
	)
...
// LIFERAY-REST-BUILDER-HASH:-2018777079
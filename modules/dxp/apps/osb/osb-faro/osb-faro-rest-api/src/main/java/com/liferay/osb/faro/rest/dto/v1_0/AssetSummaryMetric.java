...
@Generated("")
@GraphQLName(
	description = "An aggregated set of analytics metrics for a single tracked asset (page, blog, document, form, journal, object entry, etc.) over the selected date range. Counts and trends are flattened from the underlying metric tree for LLM-friendly consumption — `*TrendPercentage` fields express change vs. the previous comparable period.",
...
// LIFERAY-REST-BUILDER-HASH:-365365353
 ...
 * Cerebro engine for the <code>getSiteAssetSummariesPage</code> GraphQL
 * query (see <code>resources/graphql/getSiteAssetSummariesPage.graphql</code>).
 *
 * @author Leslie Wong
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class GetSiteAssetSummariesPageResponse {

	public AssetSummaryMetricBag getAssetSummaries() {
		return _assetSummaries;
	}

	public void setAssetSummaries(AssetSummaryMetricBag assetSummaries) {
		_assetSummaries = assetSummaries;
	}
	...
	private AssetSummaryMetricBag _assetSummaries;

 ...
 * Cerebro engine for the <code>getSiteChannelEventsPage</code> GraphQL
 * query (see <code>resources/graphql/getSiteChannelEventsPage.graphql</code>).
 *
 * @author Leslie Wong
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class GetSiteChannelEventsPageResponse {

	public EventBag getEvents() {
		return _events;
	}

	public void setEvents(EventBag events) {
		_events = events;
	}

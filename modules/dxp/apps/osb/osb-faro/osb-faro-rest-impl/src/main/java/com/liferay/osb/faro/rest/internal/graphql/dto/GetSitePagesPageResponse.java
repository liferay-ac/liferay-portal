 ...
 * Cerebro engine for the <code>getSitePagesPage</code> GraphQL query
 * (see <code>resources/graphql/getSitePagesPage.graphql</code>).
 *
 * @author Leslie Wong
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class GetSitePagesPageResponse {

	public PageMetricBag getPages() {
		return _pages;
	}

	public void setPages(PageMetricBag pages) {
		_pages = pages;
	}
	...
	public static class PageMetricBag {
		...
		public List<PageMetric> getAssetMetrics() {
		...
		public void setAssetMetrics(List<PageMetric> assetMetrics) {
		...
		private List<PageMetric> _assetMetrics;

...
import {getSelectedHistogram, mockedChartData} from './CurrentVsPreviousChart';
...
const TableView = () => {
	...
	const histogram = useMemo(
		() => getSelectedHistogram(mockedChartData, filters.metric),
		[filters.metric]
	);
	...
	const displayedItems = useMemo(() => {
		...
		return formattedData.slice(startIndex, startIndex + delta);

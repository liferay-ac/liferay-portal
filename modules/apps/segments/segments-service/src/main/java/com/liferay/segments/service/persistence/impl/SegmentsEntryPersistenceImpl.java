...
public class SegmentsEntryPersistenceImpl
	...
	public List<SegmentsEntry> findByType(
		...
		return _collectionPersistenceFinderByType.find(
			finderCache, new Object[] {ArrayUtil.sortedUnique(types)}, start,
			end, orderByComparator, useFinderCache);
	}
	...
	public List<SegmentsEntry> findBySRC_NotT(
		...
		return findBySRC_NotT(
			source, type, start, end, orderByComparator, true);
	}
	...
	public List<SegmentsEntry> findBySRC_NotT(
		...
		return _collectionPersistenceFinderBySRC_NotT.find(
			finderCache, new Object[] {new String[] {source}, type}, start, end,
			orderByComparator, useFinderCache);
	}
	...
	public SegmentsEntry findBySRC_NotT_First(
		...
		return _collectionPersistenceFinderBySRC_NotT.findFirst(
	...
	public List<SegmentsEntry> findBySRC_NotT(
		...
		return findBySRC_NotT(
			sources, type, start, end, orderByComparator, true);
	}
	...
	public List<SegmentsEntry> findByG_SRC_NotT(
		...
		return _collectionPersistenceFinderByG_SRC_NotT.find(
			finderCache,
	...
	public SegmentsEntry findByG_SRC_NotT_First(
		...
		return _collectionPersistenceFinderByG_SRC_NotT.findFirst(
			finderCache,
			new Object[] {new long[] {groupId}, new String[] {source}, type},
			orderByComparator);
	}
	...
	public List<SegmentsEntry> filterFindByG_SRC_NotT(
		...
		return _collectionPersistenceFinderByG_SRC_NotT.filterFind(
			finderCache,
			new Object[] {groupIds, ArrayUtil.sortedUnique(sources), type},
			start, end, orderByComparator, groupIds);
	}
	...
	public List<SegmentsEntry> findByG_SRC_NotT(
		...
		return findByG_SRC_NotT(
			groupIds, sources, type, start, end, orderByComparator, true);
	}
	...
	public List<SegmentsEntry> findByG_SRC_NotT(
		...
		return _collectionPersistenceFinderByG_SRC_NotT.find(
			...
			new Object[] {
				ArrayUtil.sortedUnique(groupIds),
				ArrayUtil.sortedUnique(sources), type
			},
			start, end, orderByComparator, useFinderCache);
	}
	...
	public List<SegmentsEntry> findByC_SRC_NotT(
		...
		return _collectionPersistenceFinderByC_SRC_NotT.find(
	...
	public SegmentsEntry findByC_SRC_NotT_First(
		...
		return _collectionPersistenceFinderByC_SRC_NotT.findFirst(
			finderCache, new Object[] {companyId, new String[] {source}, type},
			orderByComparator);
	}
	...
	public List<SegmentsEntry> findByC_SRC_NotT(
		...
		return findByC_SRC_NotT(
			companyId, sources, type, start, end, orderByComparator, true);
	}

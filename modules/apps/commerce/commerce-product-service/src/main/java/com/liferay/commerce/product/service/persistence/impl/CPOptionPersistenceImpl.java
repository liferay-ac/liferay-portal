...
public class CPOptionPersistenceImpl
	...
	private CollectionPersistenceFinder<CPOption>
	...
	public void activate() {
		...
		_collectionPersistenceFinderByUuid = new CollectionPersistenceFinder<>(
			...
			CPOptionModelImpl.ORDER_BY_JPQL, _ORDER_BY_ENTITY_ALIAS,
			new FinderColumn<>(
				"cpOption.", "uuid", FinderColumn.Type.STRING, "=", true, true,
				CPOption::getUuid));
		...
		_uniquePersistenceFinderByERC_C = new UniquePersistenceFinder<>(
			...
			new FinderColumn<>(
				...
				"=", true, false, CPOption::getExternalReferenceCode),
			new FinderColumn<>(
				"cpOption.", "companyId", FinderColumn.Type.LONG, "=", true,
				true, CPOption::getCompanyId));
...
// LIFERAY-SERVICE-BUILDER-HASH:-878365394
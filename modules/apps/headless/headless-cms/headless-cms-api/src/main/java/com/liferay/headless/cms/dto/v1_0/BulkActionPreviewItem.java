 ...
 */
@Generated("")
@GraphQLName("BulkActionPreviewItem")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "BulkActionPreviewItem")
public class BulkActionPreviewItem implements Serializable {

	public static BulkActionPreviewItem toDTO(String json) {
		return ObjectMapperUtil.readValue(BulkActionPreviewItem.class, json);
	}

	public static BulkActionPreviewItem unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			BulkActionPreviewItem.class, json);
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof BulkActionPreviewItem)) {
			return false;
		}

		BulkActionPreviewItem bulkActionPreviewItem =
			(BulkActionPreviewItem)object;

		return Objects.equals(toString(), bulkActionPreviewItem.toString());
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.cms.dto.v1_0.BulkActionPreviewItem",
		name = "x-class-name"
	)

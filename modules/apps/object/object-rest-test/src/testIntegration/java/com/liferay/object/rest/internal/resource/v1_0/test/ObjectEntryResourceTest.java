...
public class ObjectEntryResourceTest {
	...
	public void testGetObjectEntryWithAttachmentObjectField() throws Exception {
		FileEntry fileEntry = _addTempFileEntry(
			StringUtil.randomId(8), _objectDefinition1,
			RandomTestUtil.randomString());
			...
			ObjectEntry serviceBuilderObjectEntry =
				_objectEntryLocalService.addObjectEntry(
					...
					HashMapBuilder.<String, Serializable>put(
						...
						() -> {
							FileEntry fileEntry = _addTempFileEntry(
								StringUtil.randomId(8), objectDefinition,
								"Old Testament");
		...
		JSONObject objectEntryJSONObject = HTTPTestUtil.invokeToJSONObject(
			JSONUtil.put(
				...
				JSONFactoryUtil.createJSONObject(
					String.valueOf(
						_toFileEntry(
							Base64::encode, StringUtil.randomId(8),
	...
	public void testPutCustomObjectEntryWithLocalizedAttachmentObjectField()
		...
		String fileContent1 = StringUtil.randomId(8);
		...
		String fileContent2 = StringUtil.randomId(8);
	...
	private void _testPatchPutCustomObjectEntryWithAttachmentField(
		...
		String fileContent = StringUtil.randomId(8);
		...
		testFileEntry = _toFileEntry(
			content -> null, StringUtil.randomId(8),
			RandomTestUtil.randomString() + ".txt", null, null,
			customFileEntry1.getMimeType());
		...
		_testPatchPutCustomObjectEntryWithAttachmentField(
			...
			_toFileEntry(
				Base64::encode,
				StringUtil.randomId((_MAX_FILE_SIZE_VALUE * 1024 * 1024) + 1),
				RandomTestUtil.randomString() + ".txt", null, null,
				customFileEntry1.getMimeType()),
			httpMethod, null, objectDefinition,
			_OBJECT_FIELD_NAME_ATTACHMENT_USER_COMPUTER_TO_DOCS_AND_MEDIA_SOURCE_1,
		...
		_testPatchPutCustomObjectEntryWithAttachmentField(
			...
			_toFileEntry(
				Base64::encode, StringUtil.randomId(8), null, null, null,
				customFileEntry1.getMimeType()),
			httpMethod, null, objectDefinition,
			_OBJECT_FIELD_NAME_ATTACHMENT_USER_COMPUTER_TO_DOCS_AND_MEDIA_SOURCE_1,
			useExternalReferenceCode);
		...
		_testPatchPutCustomObjectEntryWithAttachmentField(
			...
			_toFileEntry(
				String::new, "$" + StringUtil.randomId(7),
				RandomTestUtil.randomString() + ".txt", null, null,
				customFileEntry1.getMimeType()),
			httpMethod, null, objectDefinition,
			_OBJECT_FIELD_NAME_ATTACHMENT_USER_COMPUTER_TO_DOCS_AND_MEDIA_SOURCE_1,
	...
	private void _testPostCustomObjectEntryWithAttachmentObjectField(
		...
		fileContent = StringUtil.randomId(8);

...
public class PerformanceTopAssetResourceImpl
	...
	public Page<PerformanceTopAsset> getPerformanceTopAssetPage(
		...
		if ((contextHttpServletRequest != null) &&
			...
			for (PerformanceTopAsset performanceTopAsset :
				...
				_setEmbedded(groupIds, performanceTopAsset);
			}
		}
	...
	private ObjectDefinition _getObjectDefinition(
		Map<String, ObjectDefinition> objectDefinitions, String name) {

		if (Validator.isNotNull(name) && objectDefinitions.containsKey(name)) {
	...
	private void _setEmbedded(
		Long[] groupIds, PerformanceTopAsset performanceTopAsset) {

		Map<String, ObjectDefinition> objectDefinitions = new HashMap<>();

		ObjectDefinition objectDefinition = _getObjectDefinition(
			objectDefinitions, performanceTopAsset.getMimeType());

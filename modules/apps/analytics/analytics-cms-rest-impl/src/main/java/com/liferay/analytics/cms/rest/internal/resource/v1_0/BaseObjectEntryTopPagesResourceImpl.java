...
public abstract class BaseObjectEntryTopPagesResourceImpl
	implements ObjectEntryTopPagesResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/analytics-cms-rest/v1.0/object-entry-top-pages'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "ObjectEntryTopPages"
			)
		}
	)
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/object-entry-top-pages")

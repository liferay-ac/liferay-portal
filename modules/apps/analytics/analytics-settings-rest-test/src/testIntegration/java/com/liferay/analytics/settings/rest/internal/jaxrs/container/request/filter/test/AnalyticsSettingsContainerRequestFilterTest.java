...
public class AnalyticsSettingsContainerRequestFilterTest {
	...
	private void _assertReadsAreAllowed(String emailAddress, String password)
		throws Exception {

		for (String path : _ALLOWED_READ_PATHS) {
			HttpInvoker.HttpResponse httpResponse = _invoke(
	...
	private static final String[] _ALLOWED_READ_PATHS = {
		"/contacts/account-groups", "/contacts/configuration",
		"/contacts/organizations", "/contacts/user-groups", "/fields",
		"/fields/accounts", "/fields/people"
	};

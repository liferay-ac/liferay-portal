...
public enum RecommendationNotificationType {
	...
	CONTENT_RECOMMENDER_MOST_POPULAR_ITEMS_FAILED(
		"an-unexpected-occurred,-preventing-the-most-popular-content-" +
			"recommendations-model-from-being-enabled.-go-to-instance-" +
			"settings-analytics-cloud-and-try-again",
		1),
	...
	CONTENT_RECOMMENDER_USER_PERSONALIZATION_FAILED(
		"an-unexpected-occurred,-preventing-the-user's-personalized-content-" +
			"recommendations-model-from-being-enabled.-go-to-instance-" +
			"settings-analytics-cloud-and-try-again",
		3);

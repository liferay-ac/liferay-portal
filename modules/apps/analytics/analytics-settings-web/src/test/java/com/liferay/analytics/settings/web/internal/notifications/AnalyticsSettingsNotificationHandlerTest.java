 ...
 */
public class AnalyticsSettingsNotificationHandlerTest {
	...
	public void setUp() {
		...
		ReflectionTestUtil.setFieldValue(
			_analyticsSettingsNotificationHandler, "_jsonFactory",
			new JSONFactoryImpl());
		...
		ReflectionTestUtil.setFieldValue(
			_analyticsSettingsNotificationHandler, "_portal", _portal);

		ReflectionTestUtil.setFieldValue(
			_analyticsSettingsNotificationHandler, "_language",
	...
	public void testGetBody() throws Exception {
		...
		Assert.assertEquals(
			...
			_analyticsSettingsNotificationHandler.getBody(
	...
	public void testGetLink() throws Exception {
		...
		Assert.assertEquals(
			sb.toString(),
			_analyticsSettingsNotificationHandler.getLink(
				userNotificationEvent, _serviceContext));
	}
	...
	public void testGetTitle() throws Exception {
		...
		Assert.assertEquals(
			AnalyticsSettingsNotificationType.
				CONTENT_RECOMMENDER_MOST_POPULAR_ITEMS_ENABLED.getKey(),
			_analyticsSettingsNotificationHandler.getTitle(
				userNotificationEvent, _serviceContext));
	...
	private static final AnalyticsSettingsNotificationHandler
		_analyticsSettingsNotificationHandler =
			new AnalyticsSettingsNotificationHandler();

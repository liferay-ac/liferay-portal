...
describe('Connect Step', () => {
	it('render ConnectStep without crashing', () => {
		...
		// const connectSheet = container.getElementsByClassName('sheet');
	...
	it('render card of conection with AC without crashing', () => {
		...
		const wizardInputPlacholder = getByPlaceholderText('paste-token-here');
		...
		expect(wizardInputPlacholder).toBeInTheDocument();

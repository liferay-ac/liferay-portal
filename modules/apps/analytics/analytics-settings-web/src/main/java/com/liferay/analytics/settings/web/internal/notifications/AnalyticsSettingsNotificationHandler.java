...
public class AnalyticsSettingsNotificationHandler
	extends BaseUserNotificationHandler {

	public AnalyticsSettingsNotificationHandler() {
	...
	private String _getTitle(Locale locale, int notificationTypeCode) {
		AnalyticsSettingsNotificationType analyticsSettingsNotificationType =
			AnalyticsSettingsNotificationType.fromNotificationTypeCode(
				notificationTypeCode);

		if (analyticsSettingsNotificationType != null) {
			return _language.get(
				locale, analyticsSettingsNotificationType.getKey());
		}

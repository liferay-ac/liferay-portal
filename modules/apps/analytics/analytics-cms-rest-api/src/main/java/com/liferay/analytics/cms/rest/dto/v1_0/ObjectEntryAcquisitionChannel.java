 ...
 */
@Generated("")
@GraphQLName("ObjectEntryAcquisitionChannel")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ObjectEntryAcquisitionChannel")
public class ObjectEntryAcquisitionChannel implements Serializable {

	public static ObjectEntryAcquisitionChannel toDTO(String json) {
		return ObjectMapperUtil.readValue(
			ObjectEntryAcquisitionChannel.class, json);
	}

	public static ObjectEntryAcquisitionChannel unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.analytics.cms.rest.dto.v1_0.ObjectEntryAcquisitionChannel",
		name = "x-class-name"
	)

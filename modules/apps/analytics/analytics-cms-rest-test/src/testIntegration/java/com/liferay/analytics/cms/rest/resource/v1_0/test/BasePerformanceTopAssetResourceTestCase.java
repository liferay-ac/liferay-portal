...
public abstract class BasePerformanceTopAssetResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		performanceTopAsset.setMimeType(regex);
		...
		Assert.assertEquals(regex, performanceTopAsset.getMimeType());
	...
	protected void assertValid(PerformanceTopAsset performanceTopAsset)
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("mimeType", additionalAssertFieldName)) {
				if (performanceTopAsset.getMimeType() == null) {
					valid = false;
				}
	...
	protected boolean equals(
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("mimeType", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						performanceTopAsset1.getMimeType(),
						performanceTopAsset2.getMimeType())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("mimeType")) {
			Object object = performanceTopAsset.getMimeType();
...
// LIFERAY-REST-BUILDER-HASH:-329541163
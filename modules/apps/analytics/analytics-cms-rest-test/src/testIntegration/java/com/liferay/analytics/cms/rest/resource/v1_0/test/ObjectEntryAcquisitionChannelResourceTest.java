...
public class ObjectEntryAcquisitionChannelResourceTest
	...
	public void testGetObjectEntryAcquisitionChannelsPage() throws Exception {
		try (CompanyConfigurationTemporarySwapper
			...
			Assert.assertEquals(
				"direct", objectEntryAcquisitionChannel1.getChannelName());
			Assert.assertEquals(
			...
			Assert.assertEquals(
				"social", objectEntryAcquisitionChannel2.getChannelName());
			Assert.assertEquals(
			...
			Assert.assertEquals(
				"others", objectEntryAcquisitionChannel3.getChannelName());
			Assert.assertEquals(

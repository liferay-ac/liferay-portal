...
public class SAPEntryPersistenceImpl
	...
	private CollectionPersistenceFinder<SAPEntry>
	...
	public void activate() {
		...
		_collectionPersistenceFinderByUuid = new CollectionPersistenceFinder<>(
			...
			SAPEntryModelImpl.ORDER_BY_JPQL, _ORDER_BY_ENTITY_ALIAS,
			new FinderColumn<>(
				"sapEntry.", "uuid", FinderColumn.Type.STRING, "=", true, true,
				SAPEntry::getUuid));
		...
		_collectionPersistenceFinderByC_D = new CollectionPersistenceFinder<>(
...
// LIFERAY-SERVICE-BUILDER-HASH:1606237094
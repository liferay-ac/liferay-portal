...
public class SequenceEntryPersistenceImpl
	...
	public void activate() {
		...
		_collectionPersistenceFinderByUuid = new CollectionPersistenceFinder<>(
			...
			SequenceEntryModelImpl.ORDER_BY_JPQL, _ORDER_BY_ENTITY_ALIAS,
			new FinderColumn<>(
		...
		_collectionPersistenceFinderByUuid_C =
			new CollectionPersistenceFinder<>(
				...
				_finderPathCountByUuid_C, _SQL_SELECT_SEQUENCEENTRY_WHERE,
				_SQL_COUNT_SEQUENCEENTRY_WHERE,
				SequenceEntryModelImpl.ORDER_BY_JPQL, _ORDER_BY_ENTITY_ALIAS,
				new FinderColumn<>(
					"sequenceEntry.", "uuid", FinderColumn.Type.STRING, "=",
					true, false, SequenceEntry::getUuid),
				new FinderColumn<>(
...
// LIFERAY-SERVICE-BUILDER-HASH:891435189
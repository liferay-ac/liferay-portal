...
public abstract class BaseUserSessionResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/faro-rest/v1.0/workspace/{groupId}/channels/{channelId}/accounts/{accountId}/user-sessions'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			...
			@io.swagger.v3.oas.annotations.Parameter(
				description = "ID of the account whose individuals' sessions should be listed.",
				in = io.swagger.v3.oas.annotations.enums.ParameterIn.PATH,
				name = "accountId"
			),
			@io.swagger.v3.oas.annotations.Parameter(
			...
			@io.swagger.v3.oas.annotations.Parameter(
				description = "Free text keyword search across event fields. Empty or null returns all sessions.",
				in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY,
				name = "search"
			)
		}
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path(
		"/workspace/{groupId}/channels/{channelId}/accounts/{accountId}/user-sessions"
	)
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/faro-rest/v1.0/workspace/{groupId}/channels/{channelId}/individuals/{individualId}/user-sessions'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
	...
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			...
			@io.swagger.v3.oas.annotations.Parameter(
				description = "ID of the individual whose sessions should be listed.",
				in = io.swagger.v3.oas.annotations.enums.ParameterIn.PATH,
				name = "individualId"
			),
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path(
		"/workspace/{groupId}/channels/{channelId}/individuals/{individualId}/user-sessions"
	)
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
...
// LIFERAY-REST-BUILDER-HASH:-995980178
...
/**
 * Provides the local service interface for FaroDataSourceUsage. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Matthew Kong
 * @see FaroDataSourceUsageLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FaroDataSourceUsageLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.osb.faro.service.impl.FaroDataSourceUsageLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the faro data source usage local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FaroDataSourceUsageLocalServiceUtil} if injection and service tracking are not available.
	 */
...
// LIFERAY-SERVICE-BUILDER-HASH:-2084838107
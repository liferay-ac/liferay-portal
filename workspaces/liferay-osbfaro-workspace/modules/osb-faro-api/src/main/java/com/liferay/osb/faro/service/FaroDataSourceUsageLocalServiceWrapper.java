...
public class FaroDataSourceUsageLocalServiceWrapper
	...
	public com.liferay.osb.faro.model.FaroDataSourceUsage
		addFaroDataSourceUsage(
			...
			long knownIndividualsCount, java.util.Date usageDate, long userId) {
	...
	public com.liferay.osb.faro.model.FaroDataSourceUsage
			addOrUpdateFaroDataSourceUsage(
				...
				java.util.Date usageDate, long userId)
	...
	public com.liferay.osb.faro.model.FaroDataSourceUsage
		fetchFaroDataSourceUsage(
			long faroProjectId, long dataSourceId, java.util.Date usageDate) {
	...
	public com.liferay.osb.faro.model.FaroDataSourceUsage
		...
		return _faroDataSourceUsageLocalService.updateFaroDataSourceUsage(
			faroDataSourceUsageId, dataSourceStatus, dataSourceName,
			billableEventsCount, knownIndividualsCount);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:2136571708
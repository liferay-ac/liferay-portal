...
import knownAccountsListTouchpointQuery from 'shared/queries/knownAccountsListTouchpointQuery';
...
const withData = () =>
	graphql(
		knownAccountsListTouchpointQuery('page', VIEWS_METRIC),
		getMetricsMapper((result) => ({
			items: result.page.viewsMetric.accounts.accounts,
			total: result.page.viewsMetric.accounts.total,
		}))
	);

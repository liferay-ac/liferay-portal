...
public class ProductConstants {
	...
	public static final String DATA_PLATFORM_PRODUCT_NAME =
	...
	private static final List<String> _baseProductEntryIds = Arrays.asList(
		...
		LXC_BUSINESS_PRODUCT_ENTRY_ID, LXC_CSP_100_USERS_ENTRY_ID,
	...
	private static final Map<String, String> _productNames = HashMapBuilder.put(
		...
		DATA_PLATFORM_PRODUCT_ENTRY_ID, DATA_PLATFORM_PRODUCT_NAME
	).put(
